      ...
      <div className="flex-1 px-5 md:px-8 py-6">
        ...
        <div className="flex gap-4 mb-8 flex-wrap">
          ...
          <button
            ...
            className={`px-6 py-4 rounded-3xl text-sm transition-all ${activeTab === "visited"
          ...
          <button
            ...
            className={`px-6 py-4 rounded-3xl text-sm transition-all ${activeTab === "wishlist"
              ? "bg-[#6C4DFF] text-white shadow-sm"
              : "bg-white text-[#666]"
              }`}
          >
          ...
          <button
            ...
            className={`px-6 py-4 rounded-3xl text-sm transition-all ${activeTab === "section"
              ? "bg-[#6C4DFF] text-white shadow-sm"
              : "bg-white text-[#666]"
              }`}
          >
        ...
        {activeTab === "visited" && (
          <div className="flex flex-col xl:flex-row gap-6">
            ...
            {/* FORM */}
            <div className="bg-white rounded-[32px] p-8 shadow-sm w-full xl:w-[450px] shrink-0">
            ...
            {/* MAP */}
            <div className="bg-white rounded-[32px] p-5 shadow-sm h-[750px] flex-1 min-w-0">

              <h2 className="text-3xl font-['Playfair_Display'] text-[#222] mb-5">
                Select On Map
              </h2>

              <div className="h-[650px] w-full rounded-[28px] overflow-hidden">
                <MapView
                  visited={[]}
                  wishlist={[]}
                  setCoordinates={
        ...
        {activeTab === "section" && (
          <div className="flex flex-col xl:flex-row gap-6">
            ...
            {/* MAP */}
            <div className="bg-white rounded-[32px] p-5 shadow-sm h-[850px] flex-1 min-w-0">
              ...
              <div className="h-[720px] w-full rounded-[28px] overflow-hidden border border-[#ECECEC]">
